...
export const plans = [
  {
    ...
    badge: null,
    features: [
      '1 seule plateforme connectée',
      'Template par défaut uniquement',
      'Photo de profil non importée',
      'Lien public sponsorable.gg',
      'Page avec watermark Sponsorable',
      'Statistiques non accessibles',
    ],
    locked: [
      'Choix des templates',
  ...
  },
  {
    ...
    features: [
      ...
      'Import automatique photo de profil',
      'Page sans watermark',
      'Statistiques complètes & analytics',
      'Bannière personnalisée',
      'Réorganisation des blocs de page',
      'Intégration Calendly (réservation appel)',
      'Export PDF proposition commerciale',
      'Notifications de visite',
      'Tarifs cachés (révélés sur demande)',
  ...
  },
  {
    ...
    features: [
      ...
      'Tout le plan Pro pour chaque créateur',
